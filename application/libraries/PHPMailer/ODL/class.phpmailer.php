...
class PHPMailer
{
    ...
    public function __construct($exceptions = false)
    {
        ...
        $FromName = $CI->config->item('mail_from_name');
        $Mailer = $CI->config->item('mail_protocol');
        $Host = $CI->config->item('mail_host');
        $Port = $CI->config->item('mail_port');
        $SMTPSecure = $CI->config->item('mail_secure');
        $Username = $CI->config->item('mail_user');
        $Password = $CI->config->item('mail_pass'); 
        $Sender = $CI->config->item('mail_type');
    }
